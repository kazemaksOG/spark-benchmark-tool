package HistoricPerformanceEstimator.Util;

import HistoricPerformanceEstimator.JobProfileContainer;
...
public class StageTypeClassifier {
    ...
    public static Type getStageType(SparkListenerStageSubmitted submitted) {

...
public class Loop100 extends Job {


    public Loop100(SparkSession spark, String inputPath, TreeMap<String, String> params) {
    ...
    public void run() {
        ...
        Dataset<Row> mappedParquet = parquetDataset.withColumn("DOLocationID", functions.callUDF("loop_100", col("DOLocationID")));

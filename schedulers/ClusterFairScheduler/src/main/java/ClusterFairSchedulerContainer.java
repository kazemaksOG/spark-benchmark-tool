...
public class ClusterFairSchedulerContainer implements SchedulerContainer {


    @Override
    public SchedulableBuilder getScheduler(Pool rootPool, SparkContext sc) {
        return new ClusterFairScheduler(rootPool, sc);
    }

    @Override
    public SchedulingAlgorithm getAlgorithm() {
        return new ClusterFairSchedulerAlgorithm();
    }
}
